...
#### Small simulation #1
Main parameters: $R_{\mathrm{sim}} = 750\,\mathrm{Mpc}$, $L_{z} = 50.0\,\mathrm{Mpc}$, $N_{p} = 5.0 \cdot 10^5$, $M_{p} = 1.89 \cdot 10^{11}\,\mathrm{M_\odot} - 1.85 \cdot 10^{14}\,\mathrm{M_\odot}$.
...
#### Small simulation #2
Main parameters: $R_{\mathrm{sim}} = 750\,\mathrm{Mpc}$, $L_{z} = 100.0\,\mathrm{Mpc}$, $N_{p} = 1.0 \cdot 10^6$, $M_{p} = 1.89 \cdot 10^{11}\,\mathrm{M_\odot} - 1.85 \cdot 10^{14}\,\mathrm{M_\odot}$.
